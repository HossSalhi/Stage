import { Accordion, AccordionDetails, AccordionSummary, Box, Container, Drawer, IconButton, ListItem, ListItemIcon, ListItemText, Stack, Typography, useMediaQuery } from "@mui/material";
...
import KeyboardArrowRightOutlinedIcon from "@mui/icons-material/KeyboardArrowDownOutlined";
...
const Header3 = () => {
    ...
    return (
      ...
      <Drawer
            ...
            sx={{".MuiPaper-root.css-lsozasi-MuiPaper-root-MuiDrawer-paper":{height: "100%"}}}
          >
